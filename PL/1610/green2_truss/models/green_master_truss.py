...
class GreenMasterTruss(models.Model):
    ...
    def _calculate_truss_components(self):
        ...
        no_v_support_bottom_chord_total = int(self.v_support_bottom_chord_frame) * total_frames_all

        no_v_support_bottom_chord = no_v_support_bottom_chord_total
        ...
        if self.is_bottom_chord:
            ...
            if no_v_support_bottom_chord_total > 0:
                ...
                _logger.info(f"V Support: {no_v_support_bottom_chord_total} total "
                           f"(Normal: {int(self.v_support_bottom_chord_frame) * total_normal_frames}, "
                           f"AF: {int(self.v_support_bottom_chord_frame) * total_anchor_frames})")
