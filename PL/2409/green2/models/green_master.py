...
{chr(10).join(components_without_pipes) if components_without_pipes else 'None'}"""
    ...
    def _calculate_all_components(self):
        ...
        no_af_main_columns = (self.no_of_spans + 1) * self.no_anchor_frame_lines

        no_main_columns = ((self.no_of_spans + 1) * (self.no_of_bays + 1)) - no_thick_columns - no_af_main_columns
