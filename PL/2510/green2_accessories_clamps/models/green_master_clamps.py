...
class GreenMasterClamps(models.Model):
    ...
    def _calculate_advanced_clamps(self):
        """Main method for advanced clamp calculations - Orchestrator"""
        # Import clamp type modules
        from .clamp_types import (
            w_type_clamps,
            m_type_clamps,
            arch_support_clamps,
            purlin_clamps,
        ...
        # W Type and M Type Clamps
        if self.clamp_type == 'w_type':
            w_type_clamps.accumulate_w_type_clamps(self, clamp_accumulator)
        elif self.clamp_type == 'm_type':
            m_type_clamps.accumulate_m_type_clamps(self, clamp_accumulator)
        
        # Arch Support Clamps
        if arch_support_type == 'arch_2_bottom':
            arch_support_clamps.accumulate_arch_2_bottom_clamps(self, clamp_accumulator)
        elif arch_support_type == 'arch_2_straight':
            arch_support_clamps.accumulate_arch_2_straight_clamps(self, clamp_accumulator)
        
        # Purlin Clamps
        purlin_clamps.accumulate_purlin_clamps(self, clamp_accumulator)
        
        # Arch Middle Purlin Clamps
        arch_middle_purlin_clamps.accumulate_arch_middle_purlin_clamps(self, clamp_accumulator)
        
        # Gable Purlin Clamps
        gable_purlin_clamps.accumulate_gable_purlin_clamps(self, clamp_accumulator)
        
        # V Support Clamps
        if hasattr(self, 'is_bottom_chord') and self.is_bottom_chord:
            v_support_clamps.accumulate_v_support_main_column_clamps(self, clamp_accumulator)
        
        # Vent Support Small Arch Clamps
        vent_support_clamps.accumulate_vent_support_small_arch_clamps(self, clamp_accumulator)
        
        # Cross Bracing Clamps - All Types
        cross_bracing_clamps.accumulate_front_back_cross_bracing_clamps(self, clamp_accumulator)
        cross_bracing_clamps.accumulate_internal_cc_cross_bracing_clamps(self, clamp_accumulator)
        cross_bracing_clamps.accumulate_cross_bracing_column_arch_clamps(self, clamp_accumulator)
        cross_bracing_clamps.accumulate_cross_bracing_column_bottom_clamps(self, clamp_accumulator)
        
        # Border Purlin Clamps
        border_purlin_clamps.accumulate_border_purlin_clamps(self, clamp_accumulator)
        
        # ASC Clamps
        if hasattr(self, 'is_side_coridoors') and self.is_side_coridoors:
            asc_clamps.accumulate_asc_clamps_complete(self, clamp_accumulator)
        ...
        if (hasattr(self, 'support_hockeys') and self.support_hockeys > 0 and
            ...
            asc_support_pipe_clamps.accumulate_asc_support_pipe_clamps(self, clamp_accumulator)
    ...
    def get_clamp_calculation_details(self):
        ...
        # Import clamp type modules and helpers
        ...
        if self.clamp_type == 'm_type':
            m_type_clamps.accumulate_m_type_clamps(self, temp_accumulator)
            if temp_accumulator:
            ...
            w_type_clamps.accumulate_w_type_clamps(self, temp_accumulator)
            if temp_accumulator:
                details.extend(helpers.convert_accumulator_to_details(
        ...
        # Arch Support Clamps
        if arch_support_type == 'arch_2_bottom':
            arch_support_clamps.accumulate_arch_2_bottom_clamps(self, temp_accumulator)
            if temp_accumulator:
                details.extend(helpers.convert_accumulator_to_details(
            ...
            arch_support_clamps.accumulate_arch_2_straight_clamps(self, temp_accumulator)
            if temp_accumulator:
                details.extend(helpers.convert_accumulator_to_details(
        ...
        # Purlin Clamps
        purlin_clamps.accumulate_purlin_clamps(self, temp_accumulator)
        if temp_accumulator:
            details.extend(helpers.convert_accumulator_to_details(
        ...
        # Arch Middle Purlin Clamps
        arch_middle_purlin_clamps.accumulate_arch_middle_purlin_clamps(self, temp_accumulator)
        if temp_accumulator:
            details.extend(helpers.convert_accumulator_to_details(
        ...
        # Gable Purlin Clamps
        gable_purlin_clamps.accumulate_gable_purlin_clamps(self, temp_accumulator)
        if temp_accumulator:
            details.extend(helpers.convert_accumulator_to_details(
        ...
        # V Support Clamps
        if hasattr(self, 'is_bottom_chord') and self.is_bottom_chord:
            v_support_clamps.accumulate_v_support_main_column_clamps(self, temp_accumulator)
            if temp_accumulator:
                details.extend(helpers.convert_accumulator_to_details(
        ...
        # Vent Support Small Arch Clamps
        vent_support_clamps.accumulate_vent_support_small_arch_clamps(self, temp_accumulator)
        if temp_accumulator:
            details.extend(helpers.convert_accumulator_to_details(
        ...
        # F&B Cross Bracing Clamps
        cross_bracing_clamps.accumulate_front_back_cross_bracing_clamps(self, temp_accumulator)
        if temp_accumulator:
            details.extend(helpers.convert_accumulator_to_details(
        ...
        # Internal CC Cross Bracing Clamps
        cross_bracing_clamps.accumulate_internal_cc_cross_bracing_clamps(self, temp_accumulator)
        if temp_accumulator:
            details.extend(helpers.convert_accumulator_to_details(
        ...
        cross_bracing_clamps.accumulate_cross_bracing_column_arch_clamps(self, temp_accumulator)
        if temp_accumulator:
            details.extend(helpers.convert_accumulator_to_details(
        ...
        cross_bracing_clamps.accumulate_cross_bracing_column_bottom_clamps(self, temp_accumulator)
        if temp_accumulator:
            details.extend(helpers.convert_accumulator_to_details(
        ...
        # Border Purlin Clamps
        border_purlin_clamps.accumulate_border_purlin_clamps(self, temp_accumulator)
        if temp_accumulator:
            details.extend(helpers.convert_accumulator_to_details(
        ...
        # ASC Clamps
        if hasattr(self, 'is_side_coridoors') and self.is_side_coridoors:
            asc_clamps.accumulate_asc_clamps_complete(self, temp_accumulator)
            if temp_accumulator:
                details.extend(helpers.convert_accumulator_to_details(
        ...
        if (hasattr(self, 'support_hockeys') and self.support_hockeys > 0 and
            hasattr(self, 'is_side_coridoors') and self.is_side_coridoors):
            asc_support_pipe_clamps.accumulate_asc_support_pipe_clamps(self, temp_accumulator)
            if temp_accumulator:
                details.extend(helpers.convert_accumulator_to_details(
