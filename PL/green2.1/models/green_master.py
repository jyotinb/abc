...
class GreenMaster(models.Model):
    ...
    # NEW: Side Screen Rollup Handles fields
    ...
    side_screen_component_ids = fields.One2many('component.line', 'green_master_id',   # NEW
    ...
    def _generate_component_key(self, section, name):
        """Generate a unique key for component matching - UPDATED with new component"""
        ...
        name_mappings = {
            ...
            'side screen rollup handles': 'side_screen_rollup_handles',  # NEW COMPONENT
...
{chr(10).join(components_without_pipes) if components_without_pipes else 'None'}"""
    ...
    def _calculate_all_components(self):
        """Calculate ALL components with all original calculations plus NEW Side Screen Rollup Handles"""
        component_vals = []
        ...
        # NEW: Side Screen Rollup Handles calculation
        ...
        # =============================================
        # NEW: FOUNDATION COMPONENTS (ADD THIS SECTION)
        # =============================================
        
        # Foundation components - only if foundation_length > 0
        if self.foundation_length > 0:
            
            # 1. Main Columns Foundations
            if no_main_columns > 0:
                component_vals.append(self._create_component_val(
        ...
        # SIDE SCREEN COMPONENTS (CHANGED FROM LOWER)
        ...
        # NEW: Side Screen Rollup Handles component
    ...
    # Add method for viewing message history
...
# Pipe Models (unchanged except for tracking)
