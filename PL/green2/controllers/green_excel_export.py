...
class GreenhouseExcelExport(http.Controller):
    ...
    def _create_excel_report(self, workbook, project):
        ...
        # Always create Component Management sheet
        ...
        # NEW: Create Side Screen components sheet
        ...
        # Call extension method for inherited modules
        self._create_additional_sheets(workbook, project, styles)
    
    def _create_additional_sheets(self, workbook, project, styles):
        """Hook method for inherited modules to add their own sheets"""
        # This method can be overridden in inherited modules
        pass
